...
use Arris\Entity\Handler\Factory;
...
{
    /**
     * @testdox Проверяем конструктор ArrayHandler
     *
     * @return void
     */
    ...
    /**
     * @testdox Проверяем метод ArrayHandler::pulling()
     *
     * @return void
     */
    ...
    /**
     * @testdox Проверяем метод ArrayHandler::get()
     *
     * @return void
     */
    ...
    /**
     * @testdox Проверяем метод ArrayHandler::has()
     *
     * @return void
     */
    ...
    /**
     * @testdox Проверяем метод ArrayHandler::pull()
     *
     * @return void
     */
